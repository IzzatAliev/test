package ua.com.alevel.security.filter;
...
import ua.com.alevel.exception.JwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new JwtAuthenticationException("token is invalid or expirated", HttpStatus.UNAUTHORIZED);
        }
    }
